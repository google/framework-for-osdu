...
public class DelfiDataProcessingJobTest {
    ...
    @Before
    public void init() {
        dataProcessingJob = new DelfiDataProcessingJob(srn, srnMappingService, portalService, authorizationToken, partition);
    }
    ...
    public void testNoLocation() {
        ...
        when(portalService.getRecord(eq(odesId), eq(authorizationToken), eq(partition))).thenReturn(record);
    ...
    public void testWithFileLocation() {
        ...
        when(portalService.getFile(eq("test location"), eq(authorizationToken), eq(partition))).thenReturn(fileRecord);
