...
public interface WorkflowIntegrationService {
   ...
   * @return workflow ID
   * @throws OsduServerErrorException if unable to create start workflow request
   *                      or workflow response doesn't contain workflow ID
   */
  String submitIngestToWorkflowService(WorkflowType workflowType, DataType dataType,
