...
public interface IIngestionStrategyMapper {

  IngestionStrategyEntity toEntity(IngestionStrategy ingestionStrategy);

  IngestionStrategy toIngestionStrategy(IngestionStrategyEntity entity);
