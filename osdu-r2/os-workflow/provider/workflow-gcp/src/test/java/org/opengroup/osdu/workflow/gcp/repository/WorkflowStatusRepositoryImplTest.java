...
class WorkflowStatusRepositoryImplTest {
  ...
  private static final String COLLECTION_NAME = "status-collection";
  ...
  @BeforeEach
  void setUp() {
    workflowStatusRepository = new WorkflowStatusRepositoryImpl(databaseProperties, firestore);
    given(databaseProperties.getWorkflowStatus()).willReturn(COLLECTION_NAME);
  }
