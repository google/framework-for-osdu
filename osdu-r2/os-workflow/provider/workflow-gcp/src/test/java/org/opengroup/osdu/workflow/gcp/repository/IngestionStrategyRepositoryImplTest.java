...
class IngestionStrategyRepositoryImplTest {
  ...
  private static final String COLLECTION_NAME = "strategy-collection";
  ...
  @BeforeEach
  void setUp() {
    ingestionStrategyRepository = new IngestionStrategyRepositoryImpl(databaseProperties,
        firestore);
    given(databaseProperties.getIngestionStrategy()).willReturn(COLLECTION_NAME);
  }
